...
export function CenterByMonth() {
    ...
    const { centerId,month } = route.params as RouteParamsProps;
    ...
    async function fetchGroups() {
        try {
            ...
            const response = await api.get('/sales/center/'+centerId+"/2023/"+month);
    ...
    return (
        <VStack flex={1}>
            ...
            {isLoading ? <Loading /> :
                <>
                    <CenterHeader centerId={centerId} />
                    <Pressable
                        my={4}
                        px={4}
                        h={10}
